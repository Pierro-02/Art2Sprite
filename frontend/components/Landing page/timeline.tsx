...
const timelineEvents = [
  {
    ...
    description:
      "Our journey began with a passion for AI-powered art transformation.",
    details:
  ...
  },
  {
    ...
    description:
      "Conducted extensive research on image processing and AI-based sprite generation.",
    details:
  ...
  },
  {
    ...
    description:
      "Fine-tuned Image-to-Image GAN for enhanced sprite transformation.",
    details:
  ...
  },
  {
    ...
    description:
      "Released the web-based Art2Sprite platform with post-processing tools.",
    details:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-400">
            The evolution of Art2Sprite through the years
          </p>
        </motion.div>
